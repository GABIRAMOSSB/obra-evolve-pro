      ...
      {isLoading || !data ? (
        ...
        <>
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-3">
            ...
            <Stat icon={CheckCircle2} label="Assinados" value={data.totals.signed} tone="text-emerald-600 dark:text-emerald-400" />
            <Stat icon={Clock} label="Em andamento" value={data.totals.pending} tone="text-blue-600 dark:text-blue-400" />
