...
const TIPO_COLORS: Record<CentroCustoTipo, string> = {
  administracao: "bg-blue-500/10 text-blue-700 dark:text-blue-300",
  mao_obra: "bg-amber-500/10 text-amber-700 dark:text-amber-300",
  materiais: "bg-emerald-500/10 text-emerald-700 dark:text-emerald-300",
  equipamentos: "bg-purple-500/10 text-purple-700 dark:text-purple-300",
